 ...
 *  named 0 through <em>V</em> - 1. The edges can be label.
...
public class Digraph {
     ...
     */
    public void addEdge(int v, int w, String label) {
        validateVertex(v);
        validateVertex(w);
        adj[v].add(new Edge(label, w));
        indegree[w]++;
        E++;
    }
    ...
    public Digraph reverse() {
        ...
        for (int v = 0; v < V; v++) {
            for (Edge w : adj(v)) {
                reverse.addEdge(w.index(), v, w.label());
            }
        }
        return reverse;
    }
